...
* modulesync with latest voxpupuli defaults (#134, #138)
* Explicitly ensure python-dev is installed (#129)
* Support for puppetboards offline mode (#131)
* Configure default environment for front page (#133)
